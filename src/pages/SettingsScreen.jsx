...
const icons = [
  ...
  <Ionicons name="ios-help-buoy-outline" size={28} color="black" />,
...
const SettingsScreen = () => {
  ...
  return (
    <ScrollView className="px-4 bg-white flex flex-col space-y-2">
      <SettingsItem iconComponent={<Ionicons name="ios-person-outline" size={28} color="black" />} text="Profil" onPress={()=> handleNavigate("ProfileEditScreen")}/>
      <SettingsItem iconComponent={<Ionicons name="ios-notifications-outline" size={28} color="black" />} text="Bildirimler" onPress={()=> handleNavigate("NotificationSettingsScreen")}/>
      ...
      <SettingsItem iconComponent={<Ionicons name="ios-help-buoy-outline" size={28} color="black" />} text="Yardım" onPress={()=> handleNavigate("HelpScreen")}/>
